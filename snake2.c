...
void snake_init(snake *snake1)
{
    snake1->symbol='-';
    snake1->size=3;
    snake1->direction=KEY_RIGHT;
    snake1->prev_direction=KEY_DOWN;
    snake1->tail_X=5;
    snake1->tail_Y=5;
...
int ch = getch();
    switch (ch)
        {
            case KEY_RIGHT:
                if (snake1->prev_direction==KEY_LEFT)
                {
                    snake1->head_X--;
                    break;
                }
            ...
            case KEY_LEFT:
                if (snake1->prev_direction==KEY_RIGHT)
                {
                    snake1->head_X++;
                    break;
                }
            ...
            case KEY_UP:
                if (snake1->prev_direction==KEY_DOWN)
                {
                    snake1->head_Y++;
                    break;
                }
            ...
            case KEY_DOWN:
                if (snake1->prev_direction==KEY_UP)
                {
                    snake1->head_Y--;
                    break;
                }
