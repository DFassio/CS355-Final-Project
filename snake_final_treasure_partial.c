...
//Treasure randomly ranges between 1 and 9 and lasts # of seconds depending on treasure value (IE. 1 lasts 9 secs, 2 - 8 secs) (Mike Ronalter)
void treasure_placement(int signum)
{
    ...
    {
        move_cur(treasure1.prev_Y,treasure1.prev_X);
        printf(" ");
    ...
    move_cur(treasure1.Y,treasure1.X);
    printf("%d",interval);
