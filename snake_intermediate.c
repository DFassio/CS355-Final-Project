...
//initializes the borders for the program (first and last column, first and last row, filled with X's)
void borders()
{
    int i;
...
//Move Cursor and print , used to display the moving snake
...
//Checks if any of the keys on the keyboard are being hit. Returns true if so, false if not.
int keyboard_hit(void)
{
...
//Mike Ronalter: Created border and intial setup of snake at mid point of screen moving to the right with size 5.
